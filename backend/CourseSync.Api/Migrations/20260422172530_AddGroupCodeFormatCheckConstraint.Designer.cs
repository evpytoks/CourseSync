...
namespace CourseSync.Api.Migrations
{
    ...
    [Migration("20260422172530_AddGroupCodeFormatCheckConstraint")]
    partial class AddGroupCodeFormatCheckConstraint
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CourseSync.Api.Data.CalendarEventUserState", b =>
                {
                    ...
                    b.ToTable("calendar_event_user_states", (string)null);
                });
            ...
            modelBuilder.Entity("CourseSync.Api.Data.GroupMemberBlock", b =>
                {
                    b.Property<Guid>("GroupId")
                        .HasColumnType("uuid")
                        .HasColumnName("group_id");
                    ...
                    b.ToTable("group_member_blocks", (string)null);
                });
            ...
            modelBuilder.Entity("CourseSync.Api.Data.User", b =>
                {
                    ...
                    b.Property<string>("CalendarEventTypeColors")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(4000)
            ...
            modelBuilder.Entity("CourseSync.Api.Data.CalendarEvent", b =>
                {
                    b.HasOne("CourseSync.Api.Data.Course", null)
                        .WithMany()
            ...
            modelBuilder.Entity("CourseSync.Api.Data.CalendarEventUserState", b =>
                {
                    b.HasOne("CourseSync.Api.Data.CalendarEvent", null)
                        .WithMany()
